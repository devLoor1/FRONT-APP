...
export function MyThemeProvider({ children }: { children: ReactNode }) {
  ...
  const getColorStatusBar = () => {
    if (
      ...
      currentRouteName !== "Caf"
    ) {
      return lightTheme.customColors.secondary.default;
    }

    return isDarkMode
      ? darkTheme.navigation.colors.background
      : lightTheme.customColors.baseWhite;
  };
  ...
  const paperTheme: typeof DefaultTheme = useMemo(
    () => ({
      ...
      colors: {
        ...
        placeholder: theme.navigation.dark
          ? theme.customColors.baseWhite
          : theme.customColors.baseBlack,
        outline: theme.dark
          ? theme.colors.border
      ...
      <PaperProvider theme={paperTheme}>
        ...
        >
          <StatusBar
            ...
            backgroundColor={getColorStatusBar()}
          />
          {children}
        </NavigationContainer>
      </PaperProvider>
...
export const useTheme = (): ThemeContextData => {
  ...
  if (
    !context ||
    !context.theme ||
    !context.theme.navigation ||
    !context.theme.customColors ||
    !context.theme.fonts
  ) {
