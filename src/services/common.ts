...
export const GetPublicToken = createAsyncThunk('common/getPublicToken', async () => {
...
export const GetPublicTerms = createAsyncThunk('terms/GetPublicTerms', async () => {
...
export const GetDailySummary = createAsyncThunk('common/GetDailySummary', async () => {
  const response = await api
...
export const ConfirmDailySummary = createAsyncThunk('common/ConfirmDailySummary', async () => {
  const response = await api
