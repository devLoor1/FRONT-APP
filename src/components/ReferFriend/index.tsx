      ...
      <View style={{ alignItems: "center" }}>
        <View style={styles.content}>
          ...
          <Text style={styles.desc}>
            Ganhe{" "}
            {/* {CommonMask.percent(
              recommendationStatus?.recommendation?.percentage
                .toFixed(2)
                .toString() || "0"
            )} */}
            % em cashback quando alguém se inscrever usando seu código de
            indicação e fizer o primeiro investimento.
          </Text>
          ...
          <Text style={styles.footerTxt}>
            A cada investimento realizado pelo(s) investidor(es) indicados, você
            receberá{" "}
            {/* {CommonMask.percent(
              recommendationStatus?.recommendation?.percentage
                .toFixed(2)
