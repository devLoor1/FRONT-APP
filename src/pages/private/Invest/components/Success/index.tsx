...
export default function SuccessPage() {
  ...
  const AvaliationBottomSheetRef = useRef<RBSheetRef>(null);
        ...
        <View style={styles.container}>
          <View style={{ flexGrow: 1 }}>
            ...
            <Text style={styles.desc}>
              Assim que o investimento for processado, você receberá uma
              notificação.
            </Text>
          </View>
          <View style={styles.footer}>
            ...
            <BtnDefault
              ...
              onPress={() => {
                Analytics({
                  eventName: "InvestirATSucesso_MenuMeusInvestimentos",
                });
                dispatch(resetBiometric());
