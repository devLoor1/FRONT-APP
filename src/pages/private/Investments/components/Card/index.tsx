...
type OpportunityCardProps = {
  white?: boolean;
  investment: InvestmentsResponse["data"][0];
};
    ...
    >
      <View style={{ flexDirection: "row", gap: 16 }}>
        <View style={styles.container}>
          {"image" in investment && investment.image ? (
            <Image
              source={{ uri: investment.image as string }}
              style={styles.logo}
              resizeMode="contain"
            />
          ) : (
        ...
        <View>
          <Text style={styles.modality}>{investment.modality}</Text>
      ...
      <View style={styles.content}>
        <View>
          <Text style={styles.progressTitle}>
            ...
            {CommonMask.percent(
              (
                investment.goal.confirmed_payment_percentage +
                investment.goal.percentage_awaiting_payment
              )
                .toFixed(2)
                .toString()
            )}
          ...
          <View style={styles.progress}>
            ...
            <View
              style={{
                ...styles.progressFill,
                width: `${investment.goal.confirmed_payment_percentage}%`,
              }}
            />
          </View>
        </View>
        <View style={{ gap: 8 }}>
          <View style={styles.item}>
            ...
            <Text style={styles.itemValue}>
              {CommonMask.currency(
                investment.goal.confirmed_payment_percentage.toFixed(2)
              )}
              %
            </Text>
          </View>
          <View style={styles.item}>
            ...
            <Text style={styles.itemValue}>
              {CommonMask.currency(
                investment.goal.percentage_awaiting_payment.toFixed(2)
              )}
              %
            </Text>
          </View>
        ...
        <View style={styles.valueContent}>
          ...
          <Text style={styles.value}>
            R${" "}
            {CommonMask.currency(
              (investment.monetary.min_investment_value / 100)
                .toFixed(2)
                .toString()
            )}
          </Text>
        ...
        <View style={{ gap: 8 }}>
          <View style={styles.item}>
            ...
            <Text style={styles.itemValue}>
              {investment.modality_data.participation.toFixed(2)}%
            </Text>
          </View>
          <View style={[styles.item]}>
            ...
            <Text style={styles.itemValue}>
              R${" "}
              {CommonMask.currency(
                (investment.monetary.min_investment_value / 100).toFixed(2)
              )}
            </Text>
          </View>
          <View style={styles.item}>
            ...
            <Text style={styles.itemValue}>
              R${" "}
              {CommonMask.currency(
                (investment.goal.confirmed_payment / 100).toFixed(2)
              )}
            </Text>
          </View>
          <View style={styles.item}>
